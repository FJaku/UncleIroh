...
var rand = quotes[Math.floor(Math.random() * quotes.length)]; //Get rand quote
    
var x = document.getElementsByName("q")[0]; //Read google search input

var msg = /error|stack|overflow|html|css|js|javascript|react|angular|vue/; //Common headaches

var test = msg.test(x.value) //Check against common headaches

if (test) {
    window.alert(rand) //Breathe
}
